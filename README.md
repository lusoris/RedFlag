...
Automated [Trivy](https://github.com/aquasecurity/trivy) CVE scanner for homelab container images that creates GitHub Issues for findings.
...
The scan runs automatically (daily at 06:00 UTC, weekly on Mondays at 03:00 UTC).
